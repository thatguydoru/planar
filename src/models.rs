...
impl User {
    pub async fn query_by_id(db: &SqlitePool, id: i64) -> SqlxResult<Self> {
    ...
    pub async fn change_username_by_id(
        db: &SqlitePool,
        id: i64,
        username: &str,
    ) -> SqlxResult<u64> {
    ...
    pub async fn save(mut self, db: &SqlitePool) -> SqlxResult<Self> {
